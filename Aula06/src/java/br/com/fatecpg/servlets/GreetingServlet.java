...
public class GreetingServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Aula 06: GreetingServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h4><a href='index.html'>Voltar</a></h4>");
            out.println("<h1>Aula 06</h1>");
            out.println("<h2>JavaEE</h2>");
            out.println("<h3>Servlets</h3>");
            out.println("<h4>Saudação dinâmica</h4>");
            out.println("<div style='text-align:center;background-color:black; color: white'>");
